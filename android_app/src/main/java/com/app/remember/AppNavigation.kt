...
import com.app.feature.display.DisplayLinkActivity
...
class AppNavigation: Navigation {
    ...
    override fun seeLink(context: Context, forDisplayingBookmark: Int) {
        val intent = Intent(context, DisplayLinkActivity::class.java).apply {
            putExtra(BOOKMARK_ID, forDisplayingBookmark)
        }
        context.startActivity(intent)
    }
}