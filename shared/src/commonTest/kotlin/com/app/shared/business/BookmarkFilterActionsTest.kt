...
class BookmarkFilterActionsTest: DefaultTest() {
    ...
    fun `reducer deals with Actions Bookmark Filter correctly`() {
        ...
        val bookmark3 = BookmarkState.Link(id = 3, url = "https://my.article.com/index.html", icon = null, date = 123, title = "Title", caption = "Caption", topic = topic1, isFavourite = false)
